...
// Design System song hanh o repo rieng (task-connect-agent), can nam cung
...
export default defineConfig({
  plugins: [react()],
  // Cong rieng, khac 5173 cua task-connect-fe - ca hai app chay song song tro chung 1
  // backend, can 2 origin khac nhau de phan biet trong APP_CORS_ALLOWED_ORIGINS (.env).
  server: {
    port: 5174,
  },
  resolve: {
    alias: {
      ...
      // trong node_modules cua task-connect-admin, tranh loi khong resolve duoc khi build.
