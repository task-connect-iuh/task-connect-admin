 ...
 * App.tsx (khong mount trong AdminShell.tsx vi Shell tu remount theo tung trang). zIndex 50 -
 * cao hon overlay cua Dialog (40, xem Dialog.jsx cua DS), thap hon gia tri cao nhat tung thay
 * trong DS (60), du de toast luon noi len tren dialog dang mo (vd dialog tu choi hop le).
